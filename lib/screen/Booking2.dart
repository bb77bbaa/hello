...
import 'package:test_error/screen/detail.dart';
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Container(
                    ...
                    //color: Colors.white,
                    child: Image.network(
                      'https://cms.dmpcdn.com/travel/2020/02/06/351e2770-489f-11ea-974e-5b04f5fc0e6e_original.jpg',
                      height: 500,
                      width: 400
                      ,),
                  )
              ...
              Text(
                'ทัวร์อุบล สุขใจ 3 วัน 2 คืน (รถตู้ VIP)',
